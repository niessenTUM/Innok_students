...
if user_input == "r":
    ...
    file_path_rasp = '/home/ubuntu/Desktop/Communication/' + file_name # set the path to the file in the robot
...
if user_input == "w":
    ...
    remote_path = '/home/ubuntu/Desktop/Communication/' + file_name # set the path to the file in the robot
...
if user_input == "w_i":
    ...
    # copy file from local machine to remote Raspberry Pi
    remote_path = '/home/heros/Dokumente/test_glenn/' + file_name # set the path to the file in the robot
    sftp.put(local_path, remote_path)
